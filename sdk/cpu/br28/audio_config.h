...
// #define MAX_ANA_VOL              1 // 1khz 96.0dB
// #define MAX_COM_VOL             (16)    // 具体数值应小于联合音量等级的数组大小 (combined_vol_list)
// #define MAX_DIG_VOL             (14)  //影响蓝牙播放音乐的音量输出

// {{ realhear }}
//#define REAL_DUMP_AUDIO_PCM_DATA 1   // mic pcm data dump thread open/close
// }}

#define MAX_ANA_VOL             3 //2 //2//3 // 0      //   1khz 92.5db
#define MAX_COM_VOL             (16)    //不影响辅听
#define MAX_DIG_VOL             (16)    //13 影响蓝牙播放音乐的音量输出
...
#define SYS_DEFAULT_TONE_VOL    MAX_DIG_VOL 
