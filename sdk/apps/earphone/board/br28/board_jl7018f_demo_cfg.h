#ifndef CONFIG_BOARD_JL7018F_DEMO_CFG_H
#define CONFIG_BOARD_JL7018F_DEMO_CFG_H

#include "board_jl7018f_demo_global_build_cfg.h"
...
#define HEAD_FB						    	0x02	//JL7018F FB+双麦ENC头戴降噪标准原理图
#define HEAD_HYBRID						    0x03	//JL7018F HYBRID+单麦ENC头戴降噪标准原理图
// #define CLIENT_BOARD 					    HEAD_FB
#define CLIENT_BOARD 					    HEAD_HYBRID
...
#define TCFG_UART0_TX_PORT  				IO_PORTA_05   //IO_PORT_DP                            //串口发送脚配置
...
#define TCFG_IOKEY_MFB_CONNECT_WAY			ONE_PORT_TO_LOW  //按键一端接低电平一端接IO
#define TCFG_IOKEY_MFB_ONE_PORT			    IO_PORTB_02
...
#define TCFG_IOKEY_NEXT_ONE_PORT			IO_PORTB_08

#define TCFG_IOKEY_CALL_CONNECT_WAY 		ONE_PORT_TO_LOW  //按键一端接低电平一端接IO
#define TCFG_IOKEY_CALL_ONE_PORT			IO_PORTC_02
...
#if CLIENT_BOARD == HEAD_FB
#define ANC_TRAIN_MODE						ANC_FB_EN//ANC类型配置：单前馈，单后馈，混合馈
...
//                                ANC LED 配置                                       //
//*********************************************************************************//
#define TCFG_ANCLED_ENABLE					ENABLE_THIS_MOUDLE			//是否支持ANC LED推灯模块
#define TCFG_ANCLED_PIN						IO_PORTA_06					//LED使用的IO口
/********************************ANC配置END*****************************************/
...
#if   CLIENT_BOARD == HEAD_HYBRID
#define TCFG_AUDIO_PLNK_SCLK_PIN			IO_PORTC_03
#define TCFG_AUDIO_PLNK_DAT0_PIN			IO_PORTC_04
...
#else// CLIENT_BOARD == HEAD_FB

#define TCFG_AUDIO_ADC_MIC_CHA				AUDIO_ADC_MIC_0
#endif// CLIENT_BOARD == HEAD_FB

#else // TCFG_AUDIO_DUAL_MIC_ENABLE

#if   CLIENT_BOARD == HEAD_HYBRID
#define TCFG_AUDIO_ADC_MIC_CHA				PLNK_MIC
#else// CLIENT_BOARD == HEAD_HYBRID
#define TCFG_AUDIO_ADC_MIC_CHA				AUDIO_ADC_MIC_0
#endif// CLIENT_BOARD == HEAD_HYBRID
...
#define TCFG_AUDIO_DATA_EXPORT_ENABLE		DISABLE_THIS_MOUDLE //DISABLE_THIS_MOUDLE
/*
...
//                                 Audio Smart Voice                               //
//*********************************************************************************//
#define TCFG_SMART_VOICE_ENABLE 		    ENABLE_THIS_MOUDLE //DISABLE_THIS_MOUDLE
...
//*********************************************************************************//
//是否支持外置芯片内置充电
#define TCFG_EXTERN_CHARGE_ENABLE		    DISABLE_THIS_MOUDLE
#define TCFG_EXTERN_CHARGE_PORT				IO_PORTC_04  //FULL_DET

#if TCFG_EXTERN_CHARGE_ENABLE
//外置充电需要复用内置充电芯片的充电ui流程
...
#define TCFG_PWMLED_PIN						IO_PORTC_01					//LED使用的IO口
...
#define TCFG_EXTERN_STORAGE_MODE_BOAT_PL_PORT		        IO_PORTA_05    //船运仓储模式EN口
...
//                                  linein配置                                     //
//*********************************************************************************//
#define TCFG_LINEIN_ENABLE					DISABLE_THIS_MOUDLE		// linein/AUX_DET使能
#define TCFG_LINEIN_CHECK_PORT				IO_PORTC_05				// linein检测IO
#define TCFG_LINEIN_AD_CHANNEL             	AD_CH_PC5			// 检测IO是否使用AD检测
#define TCFG_LINEIN_PORT_IN_DET_VOLTAGE     2800// 检测IO上拉使能 adc能采集的最高电压和vddiom有关
#define TCFG_LINEIN_PORT_OUT_DET_VOLTAGE    2600				// 检测IO下拉使能
...
#endif //CONFIG_BOARD_JL7018F_DEMO
#endif //CONFIG_BOARD_JL7018F_DEMO_CFG_H
