...
#define TCFG_KEY_TONE_EN					ENABLE //DISABLE 		// 按键提示音。
...
//                             lp tocuh key 配置                                   //
//*********************************************************************************//
#define TCFG_LP_TOUCH_KEY_ENABLE 			DISABLE_THIS_MOUDLE //ENABLE_THIS_MOUDLE //DISABLE_THIS_MOUDLE 		//是否使能触摸总开关
...
/*混叠DAC输出采样率*/
#define TCFG_AD2DA_LOW_LATENCY_SAMPLE_RATE      (16000)//(48000)
/*低延时 mic 通道*/
#define TCFG_AD2DA_LOW_LATENCY_MIC_CHANNEL      (AUDIO_ADC_MIC_0)  //太近，啸叫
//#define TCFG_AD2DA_LOW_LATENCY_MIC_CHANNEL      (AUDIO_ADC_MIC_2) //(AUDIO_ADC_MIC_2)
...
*/
#define TCFG_AUDIO_DAC_MODE         DAC_MODE_H1_DIFF //DAC_MODE_L_DIFF    // DAC_MODE_L_DIFF 低压， DAC_MODE_H1_DIFF 高压
...
#define ANC_CH 			 					ANC_L_CH | ANC_R_CH //| ANC_R_CH	//ANC通道使能：左通道 | 右通道
#define ANCL_FF_MIC							A_MIC0 //A_MIC0//A_MIC1					//ANC左通道FFMIC类型
...
// #define ANCR_FB_MIC							A_MIC2                //ANC右通道FBMIC类型
...
/*独立任务里面跑空间音效*/
#define TCFG_AUDIO_EFFECT_TASK_EBABLE               DISABLE_THIS_MOUDLE //ENABLE_THIS_MOUDLE

/*空间音效在线调试*/
#define TCFG_SPATIAL_EFFECT_ONLINE_ENABLE           DISABLE_THIS_MOUDLE

/*空间音频传感器是否在解码任务读传感器数据*/
#define TCFG_SENSOR_DATA_READ_IN_DEC_TASK           DISABLE_THIS_MOUDLE //ENABLE_THIS_MOUDLE
...
// //*********************************************************************************//
// //是否支持外置芯片内置充电
#define TCFG_EXTERN_CHARGE_ENABLE		    ENABLE_THIS_MOUDLE //DISABLE_THIS_MOUDLE
...
//                                  系统配置                                         //
//*********************************************************************************//
#define TCFG_AUTO_SHUT_DOWN_TIME		          36000 //180   //没有蓝牙连接自动关机时间
...
//                                  蓝牙配置                                       //
//*********************************************************************************//
#define TCFG_USER_TWS_ENABLE                      0 //1 //0   //tws功能使能
