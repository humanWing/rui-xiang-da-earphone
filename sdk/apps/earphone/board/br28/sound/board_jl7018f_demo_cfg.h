...
//*********************************************************************************//
/*辅听功能使能*/
#define TCFG_AUDIO_HEARING_AID_ENABLE		ENABLE_THIS_MOUDLE
/*听力验配功能*/
...
#define TCFG_AUDIO_DHA_AND_TONE_MUTEX		DISABLE	//辅听功能和提示音互斥
/*辅听功能MIC的采样率*/
#define TCFG_AUDIO_DHA_MIC_SAMPLE_RATE		(16000)

/*混叠DAC输出采样率*/
#define TCFG_AD2DA_LOW_LATENCY_SAMPLE_RATE      (16000)
/*低延时 mic 通道*/
...
//*********************************************************************************//
//是否支持外置芯片内置充电
#define TCFG_EXTERN_CHARGE_ENABLE		    1 //ENABLE_THIS_MOUDLE //DISABLE_THIS_MOUDLE
