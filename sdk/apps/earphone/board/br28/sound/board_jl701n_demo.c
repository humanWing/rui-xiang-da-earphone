...
#define USE_TOUCH_POWER_ON 1  //liurui
...
#else
// A: RealHear + ANC off(蓝牙)
// u8 key_table[KEY_NUM_MAX][KEY_EVENT_MAX] = {
//     // SHORT           LONG              HOLD              UP              DOUBLE                 TRIPLE
//     {KEY_HEARING_AID_TOGGLE, KEY_POWEROFF,  KEY_POWEROFF_HOLD,  KEY_NULL,     KEY_MUSIC_PP,     KEY_NULL},   //KEY_0
//     {KEY_MUSIC_NEXT, KEY_VOL_UP,    KEY_VOL_UP,         KEY_NULL,     KEY_OPEN_SIRI,              KEY_NULL},   //KEY_1
//     {KEY_MUSIC_PREV, KEY_VOL_DOWN,  KEY_VOL_DOWN,       KEY_NULL,     KEY_HID_CONTROL,            KEY_NULL},   //KEY_2
// };

// B: RealHear + ANC + ANC off(蓝牙)
// u8 key_table[KEY_NUM_MAX][KEY_EVENT_MAX] = {
//     // SHORT           LONG              HOLD              UP              DOUBLE                 TRIPLE
//     {KEY_MUSIC_PP, KEY_POWEROFF,  KEY_POWEROFF_HOLD,  KEY_NULL,     KEY_ANC_SWITCH,     KEY_NULL},   //KEY_0
//     {KEY_MUSIC_NEXT, KEY_VOL_UP,    KEY_VOL_UP,         KEY_NULL,     KEY_OPEN_SIRI,              KEY_NULL},   //KEY_1
//     {KEY_MUSIC_PREV, KEY_VOL_DOWN,  KEY_VOL_DOWN,       KEY_NULL,     KEY_HID_CONTROL,            KEY_NULL},   //KEY_2
// };
...
u8 key_table[KEY_NUM_MAX][KEY_EVENT_MAX] = {
    // SHORT           LONG              HOLD              UP              DOUBLE                 TRIPLE
    {KEY_NULL,     KEY_POWEROFF,  KEY_POWEROFF,  KEY_NULL,     KEY_NULL,     KEY_NULL},   //KEY_0
    ...
    {KEY_VOL_UP,   KEY_NULL, KEY_NULL,   KEY_NULL,  KEY_NULL,   KEY_NULL},   //KEY_3
    {KEY_ANC_SWITCH,   KEY_NULL, KEY_NULL,   KEY_NULL,  KEY_NULL,   KEY_NULL},   //KEY_4
};
#endif
//KEY_ANC_SWITCH - > KEY_HEARING_AID_TOGGLE
...
// add by liurui :20240829
    {
        .connect_way = TCFG_IOKEY_POWER_CONNECT_WAY,          //IO按键的连接方式
        .key_type.one_io.port = IO_PORTB_02,    //IO按键对应的引脚
        .key_value = 1,                                       //按键值
    },
    {
        .connect_way = TCFG_IOKEY_POWER_CONNECT_WAY,          //IO按键的连接方式
        .key_type.one_io.port = IO_PORTB_04,    //IO按键对应的引脚
        .key_value = 2,                                       //按键值
    },
    {
        .connect_way = TCFG_IOKEY_POWER_CONNECT_WAY,          //IO按键的连接方式
        .key_type.one_io.port = IO_PORTB_08,    //IO按键对应的引脚
        .key_value = 3,                                       //按键值
    },
    {
        .connect_way = TCFG_IOKEY_POWER_CONNECT_WAY,          //IO按键的连接方式
        .key_type.one_io.port = IO_PORTC_02,    //IO按键对应的引脚
        .key_value = 4,                                       //按键值
    },
    // }}
};
...
#ifdef USE_TOUCH_POWER_ON
    // add for port6
    gpio_set_pull_up(IO_PORTG_06, 0);
    gpio_set_pull_down(IO_PORTG_06, 0);
    gpio_set_direction(IO_PORTG_06, 0);
    gpio_set_output_value(IO_PORTG_06,1);

#endif // USE_TOUCH_POWER_ON
...
void board_power_init(void)
{
    ...
    power_wakeup_gpio_enable(TCFG_EXTERN_CHARGE_PORT, 0);
#endif
