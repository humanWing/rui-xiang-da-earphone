...
//#define CONFIG_BOARD_JL701N_DEMO //liurui
...
u8 key_table[KEY_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    {KEY_MUSIC_PP,   KEY_POWEROFF,  KEY_POWEROFF_HOLD,  KEY_NULL,     KEY_CALL_LAST_NO,     KEY_MODE_SWITCH},  //KEY_0   //KEY_MODE_SWITCH
